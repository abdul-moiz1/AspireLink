...
import { AlertCircle, Mail, Lock, Users } from 'lucide-react';
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/mentor/signup" className="text-emerald-600 hover:text-emerald-500 font-medium">
                Sign up here
              </Link>
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Are you a student?{' '}
              <Link href="/student/login" className="text-emerald-600 hover:text-emerald-500 font-medium">
                Student Login
              </Link>
            </p>
